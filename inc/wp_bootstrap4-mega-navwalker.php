...
class WP_Bootstrap_Navwalker extends Walker_Nav_Menu
{
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        $hasmore = get_post_meta( $item->ID, 'menu-item-mm-more', true );
        ...
        $item_output .= '<a title="' . $item->title . '"' . $attributes.' class="nav-link dropdown-item" > ';
        ...
        if ($hasFeaturedImage && $this->megaMenuID != 0) {
            ...
            $item_output .= "<img class=\"img-responsive\" alt=\"" . esc_attr($item->attr_title) . "\" src=\"" . get_the_post_thumbnail_url( $postID , 'medium' ) . "\"/>";
        }
